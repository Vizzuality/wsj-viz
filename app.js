        var map;
        var ie_cartodb1_gmapsv3, ie_cartodb2_gmapsv3;
        ...
        function initialize() {
            var mapOptions = {
                ...
                styles: [{stylers: [{ saturation: -75 }]},{featureType: "administrative",stylers: [{ visibility: "off" }]},{featureType: "road.highway",stylers: [{ gamma: 6.18 },{ hue: "#3c00ff" },{ lightness: 74 },{ saturation: 54 },{ visibility: "simplified" }]},{featureType: "road.arterial",stylers: [{ visibility: "simplified" },{ saturation: 90 },{ lightness: 54 }]},{featureType: "water",stylers: [{ saturation: 18 }]},{elementType: "labels",stylers: [{ visibility: "off" }]},{featureType: "poi.park",stylers: [{ visibility: "simplified" },{ lightness: 30 },{ saturation: -7 }]},{elementType: "labels",stylers: [{ visibility: "off" }]}]};

            map = new google.maps.Map(document.getElementById('map_canvas'), mapOptions);
            google.maps.event.addDomListener(document.getElementById('zoom_in'), 'click', function() {
                map.setZoom(map.getZoom()+1);
            });
            google.maps.event.addDomListener(document.getElementById('zoom_out'), 'click', function() {
                map.setZoom(map.getZoom()-1);
            });
			...
			$('#fullscreen').click(function(){
				...
				if($('body').hasClass('fullscreen')){
					...
					zm--;
					if(infowindow) {infowindow.hideAll()}
				}else{
